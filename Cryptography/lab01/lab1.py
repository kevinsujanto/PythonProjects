...
def single_byte_to_hex(single_char):
    ...
    if single_char >= 16:
        ret = hex(single_char)[2:]
    else:
        ret = '0' + hex(single_char)[2:]
    return str(ret)
    pass
...
print(multi_byte_to_hex(str_to_bytes("TEST STRING\x05\x05\x05\x05\x05")))
print(len(multi_byte_to_hex(str_to_bytes("TEST STRING\x05\x05\x05\x05\x05"))))
...
def hex_string_to_bytes(the_input):
    ...
    # WRITE YOUR CODE HERE
    arr = []
    ret = ([the_input[i:i+2] for i in range(0, len(the_input), 2)])
    for byte in ret:
...
def string_to_hexstring(the_input):
    ...
    """
    # WRITE YOUR CODE HERE
    return multi_byte_to_hex(str_to_bytes(the_input))
    pass
...
def hexstring_to_string(the_input):
    ...
    """
    # WRITE YOUR CODE HERE
    return bytes_to_string(hex_string_to_bytes(the_input))
    pass
...
def sha256_hexoutput(the_input):
    ...
    # WRITE YOUR CODE HERE
    import hashlib
    return str(hashlib.sha256(the_input.encode('utf-8')).hexdigest())
    pass