...
TEST_KEY = "0b93839bbf3b14f8519d98bc690bea4d" # NOTE: Just as an example, a random key would be used to test your code
...
def leaky_encipher_example(plaintext):
    ...
    X = frozenset(map(Sbox, mid_state)) # Apply Sbox to each byte of the state, 
